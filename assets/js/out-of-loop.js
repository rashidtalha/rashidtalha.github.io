const opts = { 
    ...
    "Locations":["Dog","Cat","Cow","Horse","Pig","Sheep","Goat","Rabbit","Deer","Bear","Lion","Tiger","Elephant","Giraffe","Zebra","Monkey","Gorilla","Kangaroo","Panda","Wolf","Fox","Dolphin","Whale","Bat","Squirrel","Raccoon","Hedgehog","Camel","Hippopotamus","Rhinoceros","Chicken","Duck","Goose","Turkey","Pigeon","Sparrow","Eagle","Hawk","Owl","Parrot","Penguin","Flamingo","Swan","Peacock","Crow","Robin","Seagull","Ostrich","Falcon","Woodpecker","Snake","Lizard","Turtle","Tortoise","Alligator","Crocodile","Gecko","Iguana","Chameleon","Komodo Dragon","Frog","Toad","Salamander","Newt","Axolotl","Goldfish","Salmon","Tuna","Shark","Clownfish","Angelfish","Catfish","Swordfish","Stingray","Seahorse","Ant","Bee","Butterfly","Moth","Dragonfly","Ladybug","Grasshopper","Cricket","Mosquito","Fly","Beetle","Spider","Scorpion","Wasp","Caterpillar","Jellyfish","Starfish","Octopus","Squid","Crab","Lobster","Shrimp","Snail","Worm"],
